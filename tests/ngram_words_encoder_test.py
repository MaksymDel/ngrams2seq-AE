...
from ngrams2seq import NgramWordsEncoder

class TestNgramWordsEncoder(AllenNlpTestCase):
    def setUp(self):
        ...
        self.encoder = NgramWordsEncoder.from_params(self.vocab, deepcopy(params))
